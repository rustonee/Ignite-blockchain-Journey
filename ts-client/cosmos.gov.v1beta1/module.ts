...
export { TallyResult, MsgVoteResponse, MsgDepositResponse, WeightedVoteOption, QueryProposalResponse, QueryParamsResponse, MsgSubmitProposalResponse, Deposit, QueryProposalsResponse, QueryParamsRequest, QueryDepositsResponse, TextProposal, Proposal, QueryVotesResponse, GenesisState, QueryProposalsRequest, MsgVoteWeightedResponse, Vote, TallyParams, QueryVoteResponse, QueryTallyResultRequest, MsgSubmitProposal, MsgVoteWeighted, VotingParams, QueryDepositResponse, QueryDepositsRequest, MsgDeposit, DepositParams, QueryVoteRequest, QueryTallyResultResponse, MsgVote, QueryProposalRequest, QueryVotesRequest, QueryDepositRequest };
